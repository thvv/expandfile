 ...
 * THVV 2017-06-22 v2.2 deal with HiDPI canvases
 *
 ...
 *  labelformat optional, 0 = label verbatim, 1 = "xx% label"
*/
// Copyright 2010-2013 Tom Van Vleck
//
...
function piechartcanvas(datatableid, canvasid, bgcolor, labelformat) {
    ...
    for (var piece in data) { // loop for labels
		...
		titles[piece] = Math.floor(100*thisvalue)+"% "+titles[piece];
	    }
	...
	context.textAlign = 'left';
    	context.fillText(charttitle, 3, 3);
    }
    if (chartsubtitle != '') {
	...
	context.textAlign = 'left';
    	context.fillText(chartsubtitle, 3, ch);
    }
} // piechartcanvas
